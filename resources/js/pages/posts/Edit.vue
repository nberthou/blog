...
const imagePreview = ref<string | null>(props.post.featured_image_url || null);
const hasExistingImage = ref(!!props.post.featured_image_url);
...
const submit = () => {
    form.post(update(props.post).url, {
        forceFormData: true,
        headers: {
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex justify-end gap-4 pt-4">
                    <Button variant="outline" as-child>
                        <Link :href="show(post).url">Annuler</Link>
                    </Button>
